...
PauseMenu::PauseMenu() {
    ...
    gui -> addGuiElement(new Button({250,95}, {36,36}, &PauseMenu::zoomLeft, TextureManager::loadTexture("left.png")));
    gui -> addGuiElement(new Button({350,95}, {36,36}, &PauseMenu::zoomRight, TextureManager::loadTexture("right.png")));
    
    gui -> addGuiElement(new TextElement({50,140}, "Max FPS:"));
    gui -> addGuiElement(new DisplayElement({300,140}, &Window::MAX_FPS));
    gui -> addGuiElement(new Button({250,155}, {36,36}, &PauseMenu::fpsLeft, TextureManager::loadTexture("left.png")));
    gui -> addGuiElement(new Button({350,155}, {36,36}, &PauseMenu::fpsRight, TextureManager::loadTexture("right.png")));
}
