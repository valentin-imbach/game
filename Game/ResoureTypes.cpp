...
void ResourceType::setTypes() {
    types[(int)RESOURCE::STONE] = new ResourceType(LootTable(),Sprite(TextureManager::getTexture("nature.png")),1);
    types[(int)RESOURCE::STONE] -> loot.addLoot(6,2,4);
    types[(int)RESOURCE::BUSH] = new ResourceType(LootTable(),Sprite(TextureManager::getTexture("nature.png"),{1,0}),0);
